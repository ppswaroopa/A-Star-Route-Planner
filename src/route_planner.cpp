...
// Compares the h+g values from two Nodes and returns true if the first one has a higher sum.
...
void RoutePlanner::AStarSearch() {
    RouteModel::Node *current_node = nullptr; // Initialize pointer
    open_list.push_back(start_node); // Add the starting node i.e. start_node to the open_list
    current_node = start_node; // That makes it the current node
    current_node->visited = true; // Since we start at the start_node that means we also visited it.
